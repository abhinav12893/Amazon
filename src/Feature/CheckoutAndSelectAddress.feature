Feature: Checkout and Select Delivery Address


Scenario: Sign In for checkout and select delivery address
...
And User should be signed in and Address Page should be shown
